...
--
-- Host: 127.0.0.1
-- Generation Time: 30-Nov-2017 às 19:21
...
(1, 'logo_1.png', 'facebook', 'twitter', 'instagram', '© COPYRIGHT 2017 - ACADEMICA');
...
INSERT INTO `cursos` (`id`, `nome`, `tipo`, `slug`, `imagem`, `descricao`, `carga_horaria`, `requisitos`, `informacoes`, `localidade`, `link_matricula`) VALUES
(1, 'Gestão de Pessoas', 1, 'gestao-de-pessoas', 'consultoria.png', '<p>Aperfei&ccedil;oe suas habilidades nos c&aacute;lculos de rescis&otilde;es trabalhistas e esteja atualizado quanto &agrave;s principais pr&aacute;ticas relacionadas &agrave; &aacute;rea.</p>', '15h', '<p>- Ensino Fundamental completo</p>\r\n<p>- Experi&ecirc;ncia ou conhecimento em c&aacute;lculo de rescis&atilde;o trabalhista.</p>', '<p>- Ensino Fundamental completo</p>\r\n<p>- Experi&ecirc;ncia ou conhecimento em c&aacute;lculo de rescis&atilde;o trabalhista.</p>', 'Mandaguaçu-PR', 'http://comberweb.com.br/projetos/academica/informacoes');
