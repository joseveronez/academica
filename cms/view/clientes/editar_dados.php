...
<div class="col-md-9 pull-right conteudo">
    <div class="fluid content">
        <section>
            ...
            <form action="<?= caminhoSite ?>/clientes/atualizar-dados" method="post" enctype="multipart/form-data">
            			...
            			<div class="control-group row">
                            ...
                            <div class="col-sm-10">
                                <?php
                                    if (!empty($dados->logo)) {
                                ?>
                                    <i class="fa fa-file-archive-o fa-2x" aria-hidden="true"></i>&nbsp;&nbsp;<?= $dados->logo ?><br />
                                <?php
                                    }
                                ?>
