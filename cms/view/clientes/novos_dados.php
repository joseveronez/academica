<div class="col-md-9 pull-right conteudo">
    <div class="fluid content">
        <section>
            ...
            <form action="<?= caminhoSite ?>/clientes/salvar-dados" method="post" enctype="multipart/form-data" id="formInserirDados">
            	<div class="box">
                    <div class="box-title">
                    ...
                    <div class="box-content">
            			<div class="control-group row">
                            <label class="col-sm-2 control-label" align="right">logo</label>

                            <div class="col-sm-10">
                                <input type="file" name="logo" id="logo" class="inputfile inputfile-1" required />
