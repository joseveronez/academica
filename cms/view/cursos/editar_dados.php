...
<div class="col-md-9 pull-right conteudo">
    <div class="fluid content">
        <section>
            ...
            <form action="<?= caminhoSite ?>/cursos/atualizar-dados" method="post" enctype="multipart/form-data">
            	...
            	<div class="box">
                    ...
                    <div class="box-content">
            			...
            			<div class="control-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="carga_horaria" maxlength="255" value="<?= $dados->carga_horaria ?>" />
                            </div>
                        </div><br>
            			<div class="control-group row">
                            <label class="col-sm-2 control-label" align="right">localidade</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="localidade" maxlength="255" value="<?= $dados->localidade ?>" />
                            </div>
                        </div><br>
                        <div class="control-group row">
            			...
            			<div class="control-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="link_matricula" maxlength="355" value="<?= $dados->link_matricula ?>" />
                            </div>
                        </div><br>
            		</div>
                </div><br>
