<div class="col-md-9 pull-right conteudo">
    <div class="fluid content">
        <section>
            <h1><i class="fa fa-flag" aria-hidden="true"></i>&nbsp;Banners Home - Banners</h1>
            <h4 class="sub-title">Banners</h4>

            <form action="<?= caminhoSite ?>/banners/salvar-dados" method="post" enctype="multipart/form-data" id="formInserirDados">
            	<div class="box">
                    <div class="box-title">
                        <h3 class="box-title-title"><i class="fa fa-flag" aria-hidden="true"></i>&nbsp;&nbsp;Banners</h3>
                    </div>
