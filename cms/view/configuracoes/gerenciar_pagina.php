...
<div class="col-md-9 pull-right conteudo">
    <div class="fluid content">
        <section>
            <h1><i class="fa fa-cog" aria-hidden="true"></i>&nbsp;Configurações - Gerenciar</h1>
            ...
            <form action="<?= caminhoSite ?>/configuracoes/atualizar-pagina" method="post" enctype="multipart/form-data">
                <div class="box">
                    <div class="box-title">
                        <h3 class="box-title-title"><i class="fa fa-cog" aria-hidden="true"></i>&nbsp;&nbsp;Copyright</h3>
                    </div>
                    <div class="box-content">
                        <div class="control-group row">
                            <label class="col-sm-2 control-label" align="right">copyright</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="copyright" maxlength="255" value="<?= $dados->copyright ?>" />
                            </div>
                        </div><br>
                    </div>
                </div><br />
                <div class="box">
                    <div class="box-title">
                        <h3 class="box-title-title"><i class="fa fa-cog" aria-hidden="true"></i>&nbsp;&nbsp;Logo</h3>
                    </div>
                    <div class="box-content">
                        <div class="control-group row">
                            <label class="col-sm-2 control-label" align="right">logo_header</label>

                            <div class="col-sm-10">
                                <?php
                                    if (!empty($dados->logo_header)) {
                                ?>
                                    <i class="fa fa-file-archive-o fa-2x" aria-hidden="true"></i>&nbsp;&nbsp;<?= $dados->logo_header ?><br />
                                <?php
                                    }
                                ?>
                ...
                <div class="box">
                    <div class="box-title">
                        <h3 class="box-title-title"><i class="fa fa-cog" aria-hidden="true"></i>&nbsp;&nbsp;Redes Sociais</h3>
                    </div>
                    <div class="box-content">
                        <div class="control-group row">
                        ...
                        <div class="control-group row">
                            <label class="col-sm-2 control-label" align="right">instagram</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="instagram" maxlength="255" value="<?= $dados->instagram ?>" />
                            </div>
                        </div><br>
                    </div>
                </div><br />
